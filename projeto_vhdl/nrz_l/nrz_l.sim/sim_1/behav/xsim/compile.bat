...
REM
REM Generated by Vivado on Mon May 04 21:42:28 -0300 2026
...
echo "xvhdl --incr --relax -prj tb_nrz_l_vhdl.prj"
call xvhdl  --incr --relax -prj tb_nrz_l_vhdl.prj -log xvhdl.log
