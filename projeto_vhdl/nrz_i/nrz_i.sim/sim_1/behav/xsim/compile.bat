...
REM
REM Generated by Vivado on Mon May 04 21:54:14 -0300 2026
...
echo "xvhdl --incr --relax -prj tb_nrz_i_vhdl.prj"
call xvhdl  --incr --relax -prj tb_nrz_i_vhdl.prj -log xvhdl.log
